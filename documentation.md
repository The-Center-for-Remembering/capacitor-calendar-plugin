...
```typescript
listEventsInRange(options: { startDate: number; endDate: number; calendarIds?: string[]; }) => Promise<{ result: CalendarEvent[]; }>
```
...
| Param         | Type                                                                         | Description                          |
| ------------- | ---------------------------------------------------------------------------- | ------------------------------------ |
| **`options`** | <code>{ startDate: number; endDate: number; calendarIds?: string[]; }</code> | Options for defining the date range. |
